...
// Source: internal/adapters/dto/response_writer.go
//
...
func (mr *MockResponseWriterMockRecorder) Error(err any) *gomock.Call {
...
func (mr *MockResponseWriterMockRecorder) JSON(statusCode, obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockResponseWriterMockRecorder) XML(statusCode, obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
