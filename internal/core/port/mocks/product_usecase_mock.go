...
func (mr *MockListProductsUseCaseMockRecorder) Execute(ctx, input interface{}) *gomock.Call {
...
// Execute indicates an expected call of Execute.
func (mr *MockCreateProductUseCaseMockRecorder) Execute(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Execute indicates an expected call of Execute.
func (mr *MockGetProductUseCaseMockRecorder) Execute(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Execute indicates an expected call of Execute.
func (mr *MockUpdateProductUseCaseMockRecorder) Execute(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Execute indicates an expected call of Execute.
func (mr *MockDeleteProductUseCaseMockRecorder) Execute(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
