...
func (mr *MockProductGatewayMockRecorder) Create(ctx, product interface{}) *gomock.Call {
...
func (mr *MockProductGatewayMockRecorder) Delete(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProductGatewayMockRecorder) FindAll(ctx, name, categoryID, page, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProductGatewayMockRecorder) FindByID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProductGatewayMockRecorder) Update(ctx, product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
