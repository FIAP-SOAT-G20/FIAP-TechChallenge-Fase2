...
func (m *MockOrderGateway) FindAll(ctx context.Context, customerId uint64, status string, page, limit int) ([]*entity.Order, int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOrderGatewayMockRecorder) FindAll(ctx, customerId, status, page, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAll", reflect.TypeOf((*MockOrderGateway)(nil).FindAll), ctx, customerId, status, page, limit)
}
