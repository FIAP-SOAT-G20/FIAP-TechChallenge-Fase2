...
func (mr *MockCustomerGatewayMockRecorder) Create(ctx, customer interface{}) *gomock.Call {
...
func (mr *MockCustomerGatewayMockRecorder) Delete(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCustomerGatewayMockRecorder) FindAll(ctx, name, page, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCustomerGatewayMockRecorder) FindByCPF(ctx, cpf interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCustomerGatewayMockRecorder) FindByID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCustomerGatewayMockRecorder) Update(ctx, customer interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
