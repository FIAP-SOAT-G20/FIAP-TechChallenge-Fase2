...
func (mr *MockStaffGatewayMockRecorder) Create(ctx, staff interface{}) *gomock.Call {
...
func (mr *MockStaffGatewayMockRecorder) Delete(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockStaffGateway)(nil).Delete), ctx, id)
}

// FindAll mocks base method.
func (m *MockStaffGateway) FindAll(ctx context.Context, name string, role entity.Role, page, limit int) ([]*entity.Staff, int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStaffGatewayMockRecorder) FindAll(ctx, name, role, page, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStaffGatewayMockRecorder) FindByID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStaffGatewayMockRecorder) Update(ctx, staff interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
